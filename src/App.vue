...
<template>
  <div class="min-h-screen bg-ink-50/50 dark:bg-ink-950 text-ink-950 dark:text-ink-50 transition-colors duration-300 pb-20 font-sans relative overflow-x-hidden">
    ...
    <div :class="['pointer-events-none fixed -top-40 left-1/4 h-[600px] w-[600px] rounded-full bg-emerald-500/20 dark:bg-emerald-500/12 blur-[100px] z-0 animate-glow-1', { '![animation-play-state:paused]': isAnimationsPaused }]" aria-hidden="true"></div>
    <div :class="['pointer-events-none fixed top-1/4 right-1/4 h-[800px] w-[800px] rounded-full bg-indigo-500/22 dark:bg-indigo-500/16 blur-[110px] z-0 animate-glow-2', { '![animation-play-state:paused]': isAnimationsPaused }]" aria-hidden="true"></div>
    <div :class="['pointer-events-none fixed -bottom-20 left-1/3 h-[700px] w-[700px] rounded-full bg-purple-500/18 dark:bg-purple-600/12 blur-[100px] z-0 animate-glow-3', { '![animation-play-state:paused]': isAnimationsPaused }]" aria-hidden="true"></div>
